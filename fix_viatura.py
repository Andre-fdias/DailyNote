...
def fix_viatura():
    ...
    if 'import androidx.compose.material3.OutlinedIconButton' not in content:
        content = content.replace('import androidx.compose.material3.IconButton', 'import androidx.compose.material3.IconButton\nimport androidx.compose.material3.OutlinedIconButton')
    ...
    # It starts at items(viaturas, key = { it.id }) { viatura ->
    # and ends right before if (showDialog) {
